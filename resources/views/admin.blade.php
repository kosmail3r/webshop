			...
			<div class="container">
				<div class="join">
					...
					<div class="sub-left-right">
                        <form method="post">
                            <p></p><h6>Имя категории :</h6>
                            <input type="text" name='name'>
                            <input type="hidden" name="_token" value="{{ csrf_token() }}"></p>
                            <p><h6>Описание категории :</h6>
                            <input type="text" name='description'></p>
                            <p><h6>Публиковать <input type="radio" name='is_avalibe'></h6></p>
                            <input class="morebtn at-in" type="submit" value="Создать картегорию">
                        </form>
					</div>
					<div class="clearfix"> </div>
				</div>
