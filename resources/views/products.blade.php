        	 ...
        	 <div class="limiter visible-desktop">
               <label>Show</label>
                  <select>
					...
					<ul>
					  <li>
							<a class="cbp-vm-image" href="../goods/{{$good->id}}">
								<div class="simpleCart_shelfItem">
							 <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="{{$goods->img_good}}" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Просмотреть</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">₴ {{$goods->name}}</p>
									   </div>
									   <div class="pricey"><span class="item_price">₴ {{$good->price}}</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
							...
							<a class="cbp-vm-icon cbp-vm-add item_add" href="#">Добавить в корзину</a>
							</div>
						</li>
